	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-2 sidenav">
				<img src="<c:url value='/images/bjjinfoaustria.png'/>" alt="bjjinfo"
			...
			<div class="col-sm-8 text-left">
				...
				<h1>Welcome</h1>
				<p>Servus! This page has been created to promote Brazilian Jiu
					Jitsu in Austria. You will find here info about gyms, tournaments,
					camps, seminars and more! Join our journey! OSS!</p>
				<hr>
